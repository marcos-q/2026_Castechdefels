...
#define BOTtoken "/*XXX substituiu pel token proporcionat per BotFather XXX*/"  // Codi que hem obtingut en la conversa amb BotFather
#define CHAT_ID "/*XXX substituiu pel vostre ID d'usuari de Telegram XXX*/"   // ID del nostre usuari de Telegram (codi obtngut amb IDBot)
